  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-10">
        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-rose-600/20 text-2xl text-rose-300">
          📜
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Geschichte</h1>
