  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-10">
        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-rose-600/20 text-2xl text-rose-600 dark:text-rose-300">
          📜
        </div>
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Geschichte</h1>
      ...
      <div className="rounded-xl border border-gray-200 bg-surface p-12 text-center dark:border-white/10">
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400">
          Der Geschichte-Trainer wird gerade vorbereitet. Schau bald wieder rein!
        </p>
      </div>
    </div>
  )
