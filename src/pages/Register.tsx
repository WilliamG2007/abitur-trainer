    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h2 className="mt-4 text-lg font-semibold text-white">E-Mail bestätigen</h2>
          <p className="mt-2 text-sm text-slate-400">
            Wir haben dir einen Bestätigungslink an <strong className="text-white">{email}</strong> gesendet.
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/10 bg-surface p-8">
          <h2 className="mb-6 text-lg font-semibold text-white">Konto erstellen</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-slate-400">Passwort bestätigen</label>
              <input
                type="password"
                required
                autoComplete="new-password"
