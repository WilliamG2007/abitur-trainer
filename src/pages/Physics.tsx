  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-10">
        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-amber-600/20 text-2xl text-amber-300">
          ⚡
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Physik</h1>
