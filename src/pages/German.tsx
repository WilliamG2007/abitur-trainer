  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="flex items-center gap-4 mb-10">
        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-600/20 text-2xl text-emerald-600 dark:text-emerald-300">
          Aa
        </div>
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Deutsch</h1>
